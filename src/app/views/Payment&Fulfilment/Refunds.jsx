...
const Refunds = () => {
  return (
    ...
    <div  className="mb-sm-30">
          <Breadcrumb
            routeSegments={[
              { name: "Refunds", path: "/refund_requests" },
              { name: "Refunds" }
            ]}
          />
    </div>
    <SimpleCard title="Refunds Request">
      ...
      <Table style={{ whiteSpace: "pre" }}>
        <TableHead>
          <TableRow>
            ...
            <TableCell className="px-0">Request ID</TableCell>
            <TableCell className="px-0">Order ID</TableCell>
            ...
            <TableCell className="px-0">Reason</TableCell>
